                      ...
                      if (albumMediaList.isEmpty)
                        (widget.canEdit.validate() && !appStore.isLoading)
                            ? Column(
                                ...
                                children: [
                                  50.height,
                                  Text(language.albumWithNoMedia,
                                      style: boldTextStyle()),
                                  8.height,
                                  TextButton(
                                    onPressed: () {
                                      albumId =
                                          widget.album.id.validate().toInt();
                                      AddMediaScreen(
                                    ...
                                    child: Text(
                                        "${language.add} ${widget.album.type.capitalizeFirstLetter()}",
                                        style: primaryTextStyle(
      ...
      floatingActionButton: widget.canEdit.validate()
          ? FloatingActionButton(
              onPressed: () {
                ...
                AddMediaScreen(fileType: widget.album.type)
                    .launch(context)
                    .then((value) {
                  init();
                });
