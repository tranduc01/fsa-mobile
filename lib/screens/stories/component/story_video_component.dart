...
class _CreateVideoThumbnailState extends State<CreateVideoThumbnail> {
  ...
  Widget build(BuildContext context) {
    return controller.value.isInitialized
        ...
        : Image.asset(ic_video, height: 20, width: 20, fit: BoxFit.cover);
  }
}
...
class ShowVideoThumbnailState extends State<ShowVideoThumbnail> {
  ...
  Widget build(BuildContext context) {
    return controller.value.isInitialized
        ? VideoPlayer(controller).cornerRadiusWithClipRRect(24)
        : Image.asset(ic_video, height: 18, width: 18, fit: BoxFit.cover)
            .paddingAll(8);
  }
}
