...
class TopicReplyComponent extends StatefulWidget {
  ...
  const TopicReplyComponent(
      {required this.reply,
      this.callback,
      this.showReply = true,
      required this.isParent,
      this.isFromReplyScreen = false,
      this.newReply,
      this.topicId});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text(widget.reply.createdAtDate.validate(),
                  style: secondaryTextStyle()),
              Text('#${widget.reply.id.validate().toString()}',
                  style: secondaryTextStyle(color: context.primaryColor)),
            ],
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ).visible(widget.reply.createdAtDate!.isNotEmpty &&
              widget.reply.id != null),
          10.height,
          Row(
            children: [
              cachedImage(widget.reply.profileImage.validate(),
              ...
              RichText(
                text: TextSpan(
                  children: [
                    TextSpan(
                        text: widget.reply.createdByName
                            .validate()
                            .capitalizeFirstLetter(),
                        style: primaryTextStyle(fontFamily: fontFamily)),
                    if (widget.reply.isUserVerified.validate())
                      WidgetSpan(
              ...
              Container(
                decoration: BoxDecoration(
                    ...
                    borderRadius: radius()),
                child: Text(widget.reply.key.validate(),
                    style: secondaryTextStyle(
            ...
            MemberProfileScreen(
                    memberId: widget.reply.createdById.validate().toInt())
                .launch(context);
          },
            ...
            children: [
              Align(
                ...
                alignment: Alignment.bottomRight,
                  ...
                  widget.reply.createdById.toString() == appStore.loginUserId),
              Align(
                child: TextIcon(
                  prefix: Image.asset(
                    ic_reply,
                  ...
                  onTap: () async {
                    if (widget.isParent) {
                      ...
                      TopicReplyScreen(
                              reply: widget.reply, topicId: widget.topicId)
                          .launch(context);
                    }
                  },
                ),
