...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  GlobalKey<FlutterMentionsState> postContentTextKey =
  ...
  Future<void> init() async {
    if (widget.post != null) {
      if (mediaTypeList.isNotEmpty && widget.post!.mediaType != null) {
        selectedMedia = mediaTypeList
            .firstWhere((element) => element.type == widget.post!.mediaType);
      ...
      postContentTextKey.currentState!.controller!.text =
          parseHtmlString(widget.post!.content.validate());
      setState(() {});
    }
  }
  ...
  Future<void> postIn() async {
    ...
    if (widget.groupId != null && widget.parentPostId == null) {
      postInList.insert(postInList.length - 1,
          PostInListModel(id: widget.groupId, title: widget.groupName));
      dropdownValue = postInList
          .firstWhere((element) => element.id == widget.groupId.validate());
    } else {
  ...
  Future<List<MemberResponse>> getMentionsMembers({String? mentionText}) async {
    await getAllMembers(searchText: mentionText).then((value) {
      ...
      mentionsMemberList.forEach((element) {
        userNameForMention.add({
          "full_name": element.name,
          "display": element.userLogin,
          "photo": element.avatarUrls!.full
        });
      });
    }).catchError((e) {
      toast(e.toString(), print: true);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: context.cardColor,
        title: Text(widget.post != null ? language.editPost : language.newPost,
            ...
            onTap: () async {
              ...
              ifNotTester(() async {
                if (mediaList.isEmpty &&
                    postContentTextKey.currentState!.controller!.text.isEmpty &&
                    gif == null) {
                  ...
                  await uploadPost(
                    ...
                    postMedia: mediaList,
                    content: postContentTextKey.currentState!.controller!.text
                        .replaceAll("\n", "</br>"),
                    mediaType:
                        selectedMedia != null ? selectedMedia!.type : null,
                    ...
                    type: widget.parentPostId != null
                        ? PostActivityType.activityShare
                        : null,
            ...
            child: Column(
              ...
              children: [
                ...
                if (selectedMedia != null &&
                    selectedMedia!.type != MediaTypes.gif)
                      ...
                      (index) {
                        ...
                        if (media.isLink)
                          return VideoPlayerController.networkUrl(
                              Uri.parse(mediaList[index].link.validate()));
                        else
                ...
                Row(
                  ...
                  children: [
                    Text(language.postIn, style: boldTextStyle())
                        .paddingSymmetric(horizontal: 16),
                        ...
                        child: DropdownButtonHideUnderline(
                          child: ButtonTheme(
                            ...
                            child: DropdownButton<PostInListModel>(
                              ...
                              items: postInList
                                  .map<DropdownMenuItem<PostInListModel>>((e) {
