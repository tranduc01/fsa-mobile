...
class _NotificationFragmentState extends State<NotificationFragment> {
  List<NotificationModel> notificationList = [
    NotificationModel(
      ...
      isNew: 1,
      itemId: 1,
      itemImage: 'https://i.pravatar.cc/150?img=1',
      itemName: 'Tuanblep',
      secondaryItemId: 1,
      secondaryItemImage: 'https://i.pravatar.cc/150?img=1',
      secondaryItemName: 'Tuanblep',
      isUserVerified: true,
      topicId: 1,
      requestId: '1',
      groupId: 1,
  ...
  Future<void> init() async {
    ...
    appStore.setNotificationCount(10);
  }
          ...
          Positioned(
            ...
            child: TextIcon(
              prefix: cachedImage(ic_delete,
                  color: Colors.red, width: 20, height: 20, fit: BoxFit.cover),
