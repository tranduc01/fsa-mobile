...
class NotificationWidget extends StatelessWidget {
  ...
  const NotificationWidget(
      {required this.notificationModel, required this.callback});

  @override
  Widget build(BuildContext context) {
    if (notificationModel.action == NotificationAction.friendshipAccepted ||
        notificationModel.action ==
            NotificationAction.membershipRequestAccepted) {
      return RequestAcceptedNotificationComponent(
        ...
        if (notificationModel.action == NotificationAction.friendshipAccepted) {
          MemberProfileScreen(memberId: notificationModel.itemId.validate())
              .launch(context);
        } else {
          //GroupDetailScreen(groupId: notificationModel.itemId.validate()).launch(context);
        }
      });
    } else if (notificationModel.action ==
        NotificationAction.membershipRequestRejected) {
      ...
      return CommentReplyNotificationComponent(
        ...
        SinglePostScreen(postId: notificationModel.itemId.validate())
            .launch(context);
      });
      ...
      return MentionNotificationComponent(
        ...
        NotificationAction.friendshipRequest) {
      return RequestNotificationComponent(
        ...
        NotificationAction.newMembershipRequest) {
      ...
      return GroupInviteNotificationComponent(
        ...
        NotificationAction.memberPromotedToAdmin) {
      ...
      return TopicReplyNotificationComponent(
        ...
        TopicDetailScreen(topicId: notificationModel.itemId.validate())
            .launch(context);
      });
    } else if (notificationModel.action ==
        NotificationAction.socialVSharePost) {
      ...
      return SharePostNotificationComponent(
        ...
        SinglePostScreen(postId: notificationModel.itemId.validate())
            ...
            NotificationAction.actionActivityReacted ||
        notificationModel.action ==
            NotificationAction.actionCommentActivityReacted) {
      return ReactionNotificationComponent(
        ...
        if (notificationModel.action ==
            NotificationAction.actionActivityReacted) {
          SinglePostScreen(postId: notificationModel.itemId.validate())
              .launch(context);
        } else {
          CommentScreen(postId: notificationModel.itemId.validate())
              .launch(context);
        }
      });
    } else {
